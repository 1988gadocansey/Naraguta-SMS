$(document).ready(function(){
  ...
  camera_settings=$('#camera_settings')  ;
	...
	webcam.set_swf_url('assets/swf/webcam.swf');
	webcam.set_api_url('new_member_webcam_upload.php');	// The upload script
	webcam.set_quality(90);				// JPEG Photo Quality
	webcam.set_shutter_sound(true, 'assets/swf/shutter.mp3');
