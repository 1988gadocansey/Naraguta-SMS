...
(function ($) {
	...
	var source = '<object id="XwebcamXobjectX" type="application/x-shockwave-flash" data="'+webcam.swffile+'" width="'+webcam.width+'" height="'+webcam.height+'">\n\
<param name="movie" value="'+webcam.swffile+'" />\n\
<param name="FlashVars" value="mode='+webcam.mode+'&amp;quality='+webcam.quality+'&width=' + webcam.width +
