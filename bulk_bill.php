...
<body>
    <?php
    $theclass=$_GET["form"];
   $stmt=$sql->Prepare("select tbl_student.ID as sid,PTA_OWING,surname,othernames,BILLS_OWING,GENDER,tbl_classes.class as thestage, from tbl_student,tbl_classes where students.CLASS='$theclass' and students.CLASS=tbl_classes.name $insert  order by surname asc,othernames asc ");
   $rst=$sql->Execute($stmt);
	while($t=$rst->FetchRow()){
	
	$stuid=$t['sid'];
	$sex=$t['GENDER'];
	$thenew="and (tbl_bill.stu='' or tbl_bill.stu like '%$$stuid%') and (tbl_bill.sex='' or tbl_bill.sex = '$sex') and (tbl_bill.stuType='' or tbl_bill.stuType = 'Continuing') ";
    ...
    <table width="900" height="1099" border="0">
      <tr>
        <td width="900" align="center" valign="top"><table class="breaker" width="100%" height="27" border="0" style="font-family:tahoma ; font-size:13px;" align="center">
          <tr>
              <th height="121" align="center" valign="top" scope="row"><p><img src="images/printout.png" alt="BILLBANNER" width="810" height="113" /></p>              </th>
          </tr>
          <tr>
