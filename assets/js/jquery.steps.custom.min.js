...
f).addClass("body")._showAria(b.currentIndex===c)}function T(a,b,d){if(b.enablePagination){var c="";b.forceMoveForward||(c+='<li class="pull-left"><a href="#{0}" class="btn btn-link" role="menuitem">{1}</a></li>'.format("previous",b.labels.previous));c+='<li class="pull-right"><a href="#{0}" class="btn btn-default" role="menuitem">{1}</a></li>'.format("next",b.labels.next);b.enableFinishButton&&(c+=' '.format("finish",
